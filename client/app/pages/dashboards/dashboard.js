...
function DashboardCtrl(
  ...
  this.loadDashboard = _.throttle((force) => {
    Dashboard.get(
      ...
      (dashboard) => {
        ...
        this.isDashboardOwner = currentUser.id === dashboard.user.id || currentUser.hasPermission('admin') || currentUser.hasPermission('list_dashboards');
  ...
  this.archiveDashboard = () => {
    ...
    const title = '归档看板';
    const message = `您确定要归档 "${this.dashboard.name}" 看板`;
